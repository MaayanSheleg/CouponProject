...
import com.mbms.beans.User;
import com.mbms.dao.Client;
import com.mbms.enums.ClientType;
import com.mbms.facade.CouponFacade;
...
public class LoginService {
    ...
    public Response login(String jsonOfUser) throws Exception  {
        ...
        Client facade = couponSystem.login(userFromJson.getName(), userFromJson.getPassword(), clientType);
